...
//       if(word[i].length>longLetter.length)
//       {
//         longLetter=word[i];
...
var index=0;
function addTable(){
var enterName=document.getElementById("getName").value;
console.log(enterName)
var enterClass=document.getElementById("getClass").value;
console.log(enterClass)
document.getElementById("getName").value="";
document.getElementById("getClass").value="";

//user input
var table=document.getElementById("table");
table.style.border="purple"
...
for(var i=0;i<1;i++){
  ...
  for(var j=0;j<4;j++){
    ...
    td.width = '75';
    td.setAttribute("class","tcell");
    var t=document.createTextNode(enterName);
    td.appendChild(t)
    tr.appendChild(td);
      ...
      td.setAttribute("class","tcell");
       td.width = '75';
      var t=document.createTextNode(enterClass);
      td.appendChild(t)
      tr.appendChild(td);
    }
    else{
      var btn1=document.createElement("button");
      btn1.setAttribute("onclick","deletebtn1(this)")
      // btn1.style.display="block";
      btn1.setAttribute("class","btncell");
    ...
    btn1.appendChild(deletebtn)
      ...
      btn2.setAttribute("class","btncell");
       
      var edit=document.createTextNode("Edit");
    btn2.appendChild(edit)
      tr.appendChild(btn2);
    }
  }
}
...
function editbtn(e){
 ...
 var updateVal=prompt("Enter updated name",val)
 e.parentNode.childNodes[1].nodeValue=updateVal;
 document.write(updateVal)
 var val1= e.parentNode.childNodes[2].innerHTML;
 var updateVal1=prompt("Enter updated class",val1)
 e.parentNode.childNodes[2].nodeValue=updateVal1;
 document.write(updateVal1)
 }
...
// ii. Display all child elements of “main-content” element.
  ...
  // var p = document.getElementById("main-content").childNodes.length;
  // var p = d.childNodes;
  // console.log(p)
  ...
  // console.log(p)
  // var p=d.childNodes[5];
  // console.log(p)
  // var p=d.childNodes[7];
  // console.log(p)

//   iii. Get all elements of class “render” and show their innerHTML
// in browser.
//1st method
// var length=document.getElementsByClassName("render").length
// console.log(length);
// // for(var i=0;i<length;i++){
// //   var value=document.getElementsByClassName("render")[i].innerHTML
// //   console.log(value);
// // }

//2nd Method
// var value=document.getElementsByClassName("render")
// console.log(value);
// var value=value[0].innerHTML;
// console.log(value);
// var value1=document.getElementsByClassName("render")[1].innerHTML;
// console.log(value1);
// var value2=document.getElementsByClassName("render")[2].innerHTML;
// console.log(value2);
// var value3=document.getElementsByClassName("render")[3].innerHTML;
// console.log(value3);
// var value4=document.getElementsByClassName("render")[4].innerHTML;
// console.log(value4);
...
// var lName=document.getElementById("last-name").value="Basharat";
// var eMail=document.getElementById("email").value="xyz@gmail.com"
// document.getElementsByClassName("render")[0].innerHTML="First Name is Maham"


// Question2
// i. What is node type of element having id “form-content”.
// var nodeCheck=document.getElementById("form-content").nodeType;
// alert(nodeCheck)////1
// // if 1 its a tag otherwise junk

// ii. Show node type of element having id “lastName” and its child node.
// var nodeCh=document.getElementById("lastName").nodeType;
// console.log(nodeCh);//1
// var childs=document.getElementById("lastName").childNodes[0];
// document.write(childs)

// // iii. Update child node of element having id “lastName”.
// document.getElementById("lastName").innerHTML="First Name is Maham"
// var change=document.getElementById("lastName");
// change.innerHTML="Basharat";
// document.write(change)


// iv. Get First and last child of id “main-content”.
// var firstLast=document.getElementById("main-content").childNodes.length;
// console.log(firstLast);//11 0-10
// var firstChild=document.getElementById("main-content").childNodes[1]
// console.log(firstChild.innerHTML)
// var lastChild=document.getElementById("main-content").childNodes[9].innerHTML
// console.log(lastChild)


// v. Get next and previous siblings of id “lastName”.
// var sib=document.getElementById("lastName").previousSibling.innerHTML;
// document.write(sib+"<br>");
// var sib=document.getElementById("lastName").nextSibling.innerHTML;
// document.write(sib);

// vi. Get parent node and node type of element having id “email”
// var mailget=document.getElementById("email").parentNode
// console.log(mailget)
...
// {/* <p id="pp">This is <em>important</em>!</p>
// var p=document.getElementById("pp").childNodes[1].childNodes[0];
// console.log(p) */}
